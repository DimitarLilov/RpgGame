    ...
    public class CommandSystem
    {
        ...
        private static void ResolveDamage(Character defender, int damage)
        {
            if (damage > 0)
            {
                ...
                Engine.MessageLog.Add($" {defender.Name} was hit for {damage} damage");
        ...
        private static void ResoveDeath(Character defender)
        {
            ...
            {
                Engine.MessageLog.Add($" {defender.Name} was killed, GAME OVER!!!");
                Engine.Exit();
            }
        ...
        private void Attack(Character attacker, Character defender)
        {
            ...
            Engine.MessageLog.Add(attackMessage.ToString());
            if (!string.IsNullOrWhiteSpace(defenseMessage.ToString()))
            {
                Engine.MessageLog.Add(defenseMessage.ToString());
            }
